                    ...
                    <div class="row">
                      ...
                      <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                        <div class="text-center text-sm-left mb-2 mb-sm-0 mt-3" >
                          <button class="btn btn-success mb-3" v-on:click="$router.push(`/profile/${user.id}`)">Public profile</button>
                          <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap font-weight-bold">{{this.user.username}}</h4>
                          <h5 class="pt-sm-2 pb-1 mb-0"> Listening to: <span class="font-weight-bold">{{this.user.current_song_name}} </span></h5>
                        </div>
                      </div>
                    </div>
